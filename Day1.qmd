...
We want to look at the TB data in relation to the population. The Gapminder
dataset provides the data we need.
...
We still have more than one observation per year in our TB dataset. 
Lets use summarise to collapse to one value per country.
